    ...
    var body: some View {
        VStack{
            ...
            VStack {
                ...
                Text(isAuth ? "Login" : "Registration")
                    ...
                    .background(isAuth ? Color("whiteAlpha") : Color("whiteCustom"))
               ...
               .frame(maxWidth: screen.width)
                .background(LinearGradient(colors: [Color("FoodyRed"), Color("whiteCustom")], startPoint: .leading, endPoint: .trailing))
                .clipShape(.rect(cornerRadius: 25))
                 .padding(8)
                .padding(.horizontal, 12)
                .font(.title3.bold())
        ...
        .frame(width: screen.width, height: screen.height)
            ...
            .fullScreenCover(isPresented: $isTabBarShow) {
                ...
                if AuthService.shared.currentUser?.uid == "FvzHRWC9loMDkOXbE4MYc2UtFaJ2"{
